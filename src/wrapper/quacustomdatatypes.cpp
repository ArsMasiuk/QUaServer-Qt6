...
{
    QByteArray byteArray;
    QDataStream outStream(&byteArray, QIODeviceBase::OpenMode( QDataStream::WriteOnly | QDataStream::Truncate) );
    outStream.setVersion(QDataStream::Qt_6_4);
    outStream.setByteOrder(QDataStream::BigEndian);
...
void QUaOptionSet::setValues(const quint64& values)
{
    ...
    valueStream.setVersion(QDataStream::Qt_6_4);
...
void QUaOptionSet::setValidBits(const quint64& validBits)
{
    ...
    validBitsStream.setVersion(QDataStream::Qt_6_4);
